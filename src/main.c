...
int main(int argc, char* argv[]) {
  ...
  bgfx_uniform_handle_t timeUniform =
      bgfx_create_uniform("u_time", BGFX_UNIFORM_TYPE_VEC4, 1);
  ...
  mesh_unload(mesh);
  bgfx_destroy_uniform(timeUniform);
